...
import ReceptionDemandeRdv from "./pages/accueil/DemandesRdv";
// Admin
    ...
    <ThemeProvider>
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/patient/dossier/:patientId"
            element={
              <ProtectedRoute allowedRoles={["patient"]}>
                <PatientDossier />
              </ProtectedRoute>
