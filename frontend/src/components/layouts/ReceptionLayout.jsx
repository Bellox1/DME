    ...
    const menuSections = [
        {
            ...
            items: [
                ...
                { path: '/accueil/patients', icon: 'person_search', label: 'Liste Patients' },
                { path: '/accueil/enregistrement', icon: 'person_add', label: 'Inscription' },
            ]
        },
        {
            title: 'Gestion Soins',
            items: [
                ...
                { path: '/accueil/demandesrdv', icon: 'notification_important', label: 'Demandes rdv' },
        ...
        },
        {
            ...
            items: [
                ...
                { path: '/accueil/notifications', icon: 'notifications', label: 'Notifications' },
                            ...
                            <div className="flex items-center gap-4 relative" ref={dropdownRef}>
                                ...
                                {isProfileOpen && (
                                    <div className="absolute top-[calc(100%+12px)] right-0 w-72 bg-white dark:bg-[#1c2229] border border-slate-200 dark:border-[#2d363f] rounded-2xl shadow-2xl shadow-black/10 z-[60] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                        ...
                                        <div className="p-2">
                                            <Link to="/accueil/profil" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-[#252c35] group transition-all" onClick={() => setIsProfileOpen(false)}>
                                            ...
                                            <Link to="/accueil/aide" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-[#252c35] group transition-all" onClick={() => setIsProfileOpen(false)}>
                                                <div className="size-10 rounded-lg bg-slate-100 dark:bg-[#15191d] group-hover:bg-primary/10 flex items-center justify-center">
