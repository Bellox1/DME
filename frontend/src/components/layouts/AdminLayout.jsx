    ...
    const menuSections = [
        {
            title: 'Menu',
            items: [
                { path: '/admin', icon: 'dashboard', label: 'Tableau de bord' },
                { path: '/admin/stats', icon: 'monitoring', label: 'Statistiques' },
                { path: '/admin/logs', icon: 'bar_chart', label: 'Logs Système' },
        ...
        },
        {
            title: 'Utilisateurs',
            items: [
                { path: '/admin/utilisateurs', icon: 'group', label: 'Liste des utilisateurs' },
                { path: '/admin/inscription', icon: 'person_add', label: 'Ajouter un compte' },
            ]
        },
        {
            title: 'Configuration',
            items: [
                { path: '/admin/parametres', icon: 'settings', label: 'Paramètres & Rôles' },
            ]
        },
        {
            title: 'Compte',
                        ...
                        <div className="flex items-center gap-3 md:gap-6 ml-3 md:ml-6">
                            ...
                            <div className="flex items-center gap-4 relative" ref={dropdownRef}>
                                ...
                                >
                                    ...
                                    <span className="absolute -top-1 -right-1 size-5 bg-red-500 text-white text-[10px] font-black rounded-full flex items-center justify-center border-2 border-white dark:border-slate-900 shadow-sm">
                                        2
                                    </span>
                                </Link>
                                ...
                                {isProfileOpen && (
                                    <div className="absolute top-[calc(100%+12px)] right-0 w-72 bg-white dark:bg-[#1c2229] border border-slate-200 dark:border-[#2d363f] rounded-2xl shadow-2xl shadow-black/10 z-[60] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                        ...
                                        <div className="p-2">
                                            <Link to="/admin/profil" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-[#252c35] group transition-all" onClick={() => setIsProfileOpen(false)}>
                                            ...
                                            <Link to="#" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-[#252c35] group transition-all" onClick={() => setIsProfileOpen(false)}>
                                                <div className="size-10 rounded-lg bg-slate-100 dark:bg-[#15191d] group-hover:bg-primary/10 flex items-center justify-center">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] text-[#6c757f]">Support technique</span>
                                                </div>
                                            </Link>
                                        </div>
