...
const ResetPassword = () => {
    ...
    useEffect(() => {
        const verify = async () => {
            ...
            // Strictly require 'number' parameter
            ...
            setFormData(prev => ({ ...prev, login: number }));
            setVerifying(false);
        };
        verify();
    ...
    if (verifying) {
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center">
                ...
                <p className="mt-4 text-slate-500 font-medium italic">Vérification...</p>
            </div>
        );
    }
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4">
                <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl p-12 max-w-md w-full text-center space-y-6 animate-in zoom-in-95 duration-500">
                    <div className="size-20 bg-green-100 rounded-full flex items-center justify-center mx-auto text-green-600">
                        <span className="material-symbols-outlined text-4xl">verified</span>
                    </div>
                    <h1 className="text-2xl font-black text-titles dark:text-white uppercase italic">Mot de passe réinitialisé !</h1>
                    <p className="text-slate-500 dark:text-slate-400 font-medium italic">
                        Votre nouveau mot de passe a été enregistré. Redirection vers la connexion...
                    </p>
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col lg:flex-row shadow-inner overflow-hidden">
            ...
            <div className="hidden lg:flex w-1/2 bg-slate-900 relative overflow-hidden items-center justify-center p-20 text-white">
                <div className="absolute inset-0 opacity-20">
                    <div className="absolute top-[-10%] left-[-10%] size-96 bg-primary rounded-full blur-[100px] animate-pulse"></div>
                    <div className="absolute bottom-[-10%] right-[-10%] size-[500px] bg-primary rounded-full blur-[120px]"></div>
                </div>

                <div className="relative z-10 flex flex-col gap-8">
                    <div className="bg-white/10 backdrop-blur-xl p-8 rounded-[3rem] border border-white/10 w-fit">
                        <Logo size="lg" light />
                    </div>
                    <div className="space-y-4">
                        <h2 className="text-5xl font-black tracking-tighter uppercase italic leading-none">
                            Réinitialisez <br /> <span className="text-primary">Votre Sécurité</span>
                        </h2>
                        <p className="text-xl text-white/50 font-medium italic max-w-md">
                            Choisissez un nouveau mot de passe robuste pour protéger l'accès à vos données de santé.
                        </p>
                    </div>
                </div>
            </div>
            ...
            {/* Form Side */}
            <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative transition-all">
                ...
                <div className="w-full max-w-md space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="space-y-2">
                        <h1 className="text-3xl md:text-4xl font-black text-titles dark:text-white uppercase italic tracking-tighter">Nouveau Mot de Passe</h1>
                        <p className="text-slate-400 font-bold italic uppercase tracking-widest text-[10px]">Compte : {formData.login}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2 group">
                            ...
                            <div className="relative">
                                <span className="absolute left-5 top-1/2 -translate-y-1/2 material-symbols-outlined text-slate-400 group-focus-within:text-primary transition-colors">lock</span>
                                <input
