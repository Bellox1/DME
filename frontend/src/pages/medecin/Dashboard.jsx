                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <h1 className="text-3xl md:text-5xl font-black tracking-tighter leading-none italic uppercase">
                                Bonjour, <span className="text-white/80">{userName.prenom} {userName.nom}</span> 👋
                            </h1>
                            <p className="text-lg text-white/70 font-medium italic max-w-md">
                                Votre planning est prêt. Vous avez <span className="text-white font-bold underline decoration-white/30">{stats.waiting} patients</span> qui attendent en file d'attente.
                            </p>
                        </div>
