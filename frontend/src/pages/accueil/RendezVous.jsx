            ...
            <div className="p-4 md:p-8 max-w-7xl mx-auto w-full flex flex-col gap-6 md:gap-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div className="flex flex-col gap-1">
                        <h1 className="text-2xl md:text-3xl font-black text-titles dark:text-white tracking-tight italic uppercase">Gestion des Rendez-vous</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8 bg-white dark:bg-[#1c2229] border border-slate-200 dark:border-[#2d363f] rounded-[2.5rem] p-6 md:p-8 shadow-sm">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                            <h3 className="text-lg md:text-xl font-black text-titles dark:text-white uppercase italic tracking-tighter">Planning d'aujourd'hui</h3>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs md:text-sm font-black text-titles dark:text-white px-4 py-2 bg-slate-50 dark:bg-slate-800 rounded-xl uppercase italic tracking-tighter whitespace-nowrap">
                        ...
                        <div className="space-y-4">
                            {rdv.length === 0 ? (
                                ...
                                rdv.map((item) => (
                                    <div key={item.id} className="flex items-center gap-4 md:gap-6 p-4 md:p-5 rounded-2xl border border-slate-50 dark:border-slate-800 hover:bg-slate-50 transition-all group cursor-pointer">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className="bg-white dark:bg-[#1c2229] border border-slate-200 dark:border-[#2d363f] rounded-[2.5rem] p-8 shadow-sm">
                            <h3 className="text-base font-black text-titles dark:text-white mb-6 uppercase tracking-widest italic">Demandes en attente</h3>
                            <div className="space-y-4">
                                {demandes.filter(d => d.statut === 'en_attente').length === 0 ? (
                                    <p className="text-slate-500 dark:text-slate-400 text-sm font-medium italic">Aucune demande en attente</p>
                                ) : (
                                    demandes.filter(d => d.statut === 'en_attente').map((demande) => (
                                        <div key={demande.id} className="p-4 border border-slate-100 dark:border-slate-800 rounded-2xl space-y-3">
